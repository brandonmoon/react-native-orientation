...
{
    if ((self = [super init])) {
        [Orientation setOrientation:[[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad ? UIInterfaceOrientationMaskAll :UIInterfaceOrientationMaskAllButUpsideDown];
...
#endif
    // UI Device LEFT == UI Interface RIGHT
...
#endif
    // UI Device RIGHT == UI Interface LEFT
...
#endif
    [Orientation setOrientation:isIPad ? UIInterfaceOrientationMaskAll : UIInterfaceOrientationMaskAllButUpsideDown];
